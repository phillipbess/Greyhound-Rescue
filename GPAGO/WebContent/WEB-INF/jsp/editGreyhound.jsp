...
<script>
$(document).ready(function(){ $("#btnLeft").click(function () { var
selectedItem = $("#rightValues option:selected");
$("#leftValues").append(selectedItem); }); });
$(document).ready(function(){ $("#btnRight").click(function () { var
...
$("#rightValues").append(selectedItem); }); });
	...
	<jsp:useBean id="greyhound" type="gpago.view.GreyhoundFormBean"
		scope="request" />
	<jsp:useBean id="facade" class="gpago.view.ViewFacade" scope="request" />

	<form method="post" enctype="multipart/form-data"
		action="save-greyhound">
		...
		<div class="detail">
			<div class="inputField">
				<label>Name</label><input type="text" name="name"
					value="${greyhound.name}" />${greyhound.nameValidationText}
			</div>
			<div class="inputField">
				<label>Date of Birth</label><input type="date" name="dateOfBirth"
					placeholder="mm/dd/yyyy" value="${greyhound.dateOfBirth}" />
			</div>
			<div class="inputField">
				<label>Gender</label><select name="gender">
					<option value='${greyhound.gender}' disabled selected
						style='display: none;'>${greyhound.gender}</option>
			...
			<div class="inputField">
				<label>Color</label><select name="color">
					<option value='${greyhound.color}' disabled selected
						style='display: none;'>${greyhound.color}</option>
					...
					<option value="White Ticked Dark Brindle">White Ticked
						Dark Brindle</option>
					<option value="White Ticked Fawn">White Ticked Fawn</option>
					<option value="White Ticked Light Brindle">White Ticked
						Light Brindle</option>
					<option value="White Ticked Red">White Ticked Red</option>
					<option value="White Ticked Red Brindle">White Ticked Red
						Brindle</option>
					<option value="White Ticked Red Fawn">White Ticked Red
						Fawn</option>
				</select>
			</div>
			<div class="inputField">
				<label>Personality</label><input type="text" name="personality"
					value="${greyhound.personality}" />
			</div>
			<div class="inputField">
				<label>More info</label>
				<textarea name="moreInfo">${greyhound.moreInfo}</textarea>
			</div>
			<div class="inputField">
				<label>Cat Friendly</label><input type="checkbox" name="catFriendly"
			...
			<div class="inputField">
				<label>Location</label> <select name="location">
					<option value='${greyhound.location}' disabled selected
						style='display: none;'>${greyhound.location}</option>
					<option value="Foster Home">Foster Home</option>
					<option value="Kennel">Kennel</option>
				</select>
			</div>
			<div class="inputField">
				<label>Adoption Status</label> <select name="adoptionStatus">
					<option value='${greyhound.adoptionStatus}' disabled selected
						style='display: none;'>${greyhound.adoptionStatus}</option>
		...
		<div class="formButtons">
			...
			<button type="button"
				onclick="window.location='manage-greyhounds';return false;">Cancel</button>
		</div>
	</form>
